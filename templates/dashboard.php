...
<html lang="en">
	...
	<head><base href="">
		...
		<link href=" <?php echo WP_PLUGIN_DIR . '/business-dashboard/views/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css';?>" rel="stylesheet" type="text/css" />
		<!--end::Page Vendor Stylesheets-->
		<!--begin::Global Stylesheets Bundle(used by all pages)-->

		<link href="<?php echo WP_PLUGIN_DIR . '/business-dashboard/views/assets/plugins/global/plugins.bundle.css';?>" rel="stylesheet" type="text/css" />

		<link href="<?php echo WP_PLUGIN_DIR . '/business-dashboard/views/assets/css/style.bundle.css';?>" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-tablet-and-mobile-fixed aside-enabled">
		...
		<!--end::Scrolltop-->
		<!--end::Main-->
		<script>var hostUrl = "<?php echo WP_PLUGIN_DIR . '/business-dashboard/views/assets';?>"</script>
		<!--begin::Javascript-->
		<!--begin::Global Javascript Bundle(used by all pages)-->

        <script src="<?php echo WP_PLUGIN_DIR . '/business-dashboard/views/assets/plugins/global/plugins.bundle.js';?>"></script>




		<script src="<?php echo WP_PLUGIN_DIR . '/business-dashboard/views/assets/js/scripts.bundle.js';?>"></script>
		<!--end::Global Javascript Bundle-->
		<!--begin::Page Vendors Javascript(used by this page)-->
		<script src="<?php echo WP_PLUGIN_DIR . '/business-dashboard/views/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js';?>"></script>
		<!--end::Page Vendors Javascript-->
		<!--begin::Page Custom Javascript(used by this page)-->
		<script src="<?php echo WP_PLUGIN_DIR . '/business-dashboard/views/assets/js/custom/widgets.js';?>"></script>
		<script src="<?php echo WP_PLUGIN_DIR . '/business-dashboard/views/assets/js/custom/apps/chat/chat.js';?>"></script>
		<script src="	<?php echo WP_PLUGIN_DIR . '/business-dashboard/views/assets/js/custom/modals/create-app.js';?>"></script>
		<script src="<?php echo WP_PLUGIN_DIR . '/business-dashboard/views/assets/js/custom/modals/upgrade-plan.js';?>"></script>
